	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'evstrap' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'evstrap' ); ?></th>
			</tr>
		</thead>
		<tbody>
