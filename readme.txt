...
Start talking: [![Gitter](https://img.shields.io/gitter/room/holger1411/evstrap.svg?maxAge=2592000?style=flat-square)](https://gitter.im/holger1411/evstrap)
...
Website: [https://evstrap.com](https://evstrap.com)

Child Theme Project: [https://github.com/holger1411/evstrap-child](https://github.com/holger1411/evstrap-child)
...
- Jetpack ready.
- WooCommerce support.
- [Child Theme](https://github.com/holger1411/evstrap-child) ready.
- Translation ready.
...
- The `/css/theme.css` and it´s minified little brother `/css/theme.min.css` file(s) provides all styles. It is composed of five different SCSS sets and one variable file at `/sass/theme.scss`:
                  ...
                  - 3 "evstrap/evstrap"; // <--------- Some basic WordPress stylings and needed styles to combine Boostrap and Underscores
...
- Download the evstrap folder from GitHub or from evstrap.com
- IMPORTANT: If you download it from GitHub make sure you rename the "evstrap-master.zip" file just to "evstrap.zip" or you might have problems using child themes !!
